...
function Nav() {
  ...
  return (
    <>
      <nav className="sb-topnav navbar navbar-expand navbar-dark bg-info text-white border-bottom border-dark">
        {/* <!-- Navbar Brand--> */}
        ...
        {/* <!-- Navbar Search--> */}
        <form
          className="d-none d-md-inline-block form-inline ms-auto me-0
