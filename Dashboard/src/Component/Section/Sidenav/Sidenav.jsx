          ...
          <div className="nav">
            ...
            >
              <div className="sb-nav-link-icon">
                ...
                >
                  <path
                    fill="currentColor"
                    d="M448 32C483.3 32 512 60.65 512
            ...
            >
              <nav className="sb-sidenav-menu-nested nav">
                <Link to="/TableUsers" className="nav-link">
                  Users
                </Link>
                <Link to="/TableAdmin" className="nav-link">
                  Admin
                </Link>
              </nav>
            </div>
            ...
            <div className="sb-sidenav-menu-heading">CONTROL INTERFACES</div>
            {/* <!-- Start tables Shops  --> */}
            <a
              className="nav-link collapsed"
              href="#"
